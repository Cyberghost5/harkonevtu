        ...
        <div class="divide-y divide-slate-100">
            ...
            <div class="px-6 py-6">
                <h4 class="text-lg font-bold text-slate-800 mb-4">
                    Payvessel
                    <span class="text-sm font-normal text-slate-400 ml-1">from
                        <a href="https://payvessel.com" target="_blank" class="text-blue-500 hover:underline">Payvessel</a>
                    </span>
                </h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1">API Key</label>
                        <input type="text" name="payvessel_api_key" value="{{ $s['payvessel_api_key'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1">Secret Key</label>
                        <input type="text" name="payvessel_secret_key" value="{{ $s['payvessel_secret_key'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-slate-500 mb-1">Business ID</label>
                        <input type="text" name="payvessel_business_id" value="{{ $s['payvessel_business_id'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-6">
                <h4 class="text-lg font-bold text-slate-800 mb-4">
                    Monnify
                    <span class="text-sm font-normal text-slate-400 ml-1">from
                        <a href="https://app.monnify.com" target="_blank" class="text-blue-500 hover:underline">Monnify</a>
                    </span>
                </h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1">Contract No.</label>
                        <input type="text" name="monnify_contract_no" value="{{ $s['monnify_contract_no'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-slate-500 mb-1">Monnify API</label>
                        <input type="text" name="monnify_api" value="{{ $s['monnify_api'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-6">
                <h4 class="text-lg font-bold text-slate-800 mb-4">
                    Weather API
                    <span class="text-sm font-normal text-slate-400 ml-1">from
                        <a href="https://openweathermap.org" target="_blank" class="text-blue-500 hover:underline">OpenWeather</a>
                    </span>
                </h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1">Key ID</label>
                        <input type="text" name="openweather_api_key" value="{{ $s['openweather_api_key'] ?? '' }}"
                               class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500">
                    </div>
                </div>
            </div>

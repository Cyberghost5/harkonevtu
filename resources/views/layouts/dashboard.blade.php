        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="flex-shrink-0 flex items-center justify-between h-16 px-4 sm:px-6
                ...
                <div class="flex items-center gap-2 ml-auto">
                    ...
                    {{-- Notifications --}}
                    <button class="relative p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                    ...
                    {{-- Avatar --}}
                    <div class="h-9 w-9 rounded-xl bg-gradient-to-tr from-vtu-primary to-vtu-secondary flex items-center justify-center text-white text-xs font-bold shadow-md shadow-indigo-500/20 cursor-pointer">
                        {{ auth()->user()->initials() }}
                    </div>
                </div>
            </header>

                    ...
                    <div class="col-span-1">
                        ...
                        <ul class="space-y-2.5 text-xs text-slate-300">
                            <li class="flex items-start gap-2">
                                ...
                                <span>Suite E106, Ramat Shopping Complex, Sir Kashim Ibrahim Way, P.O Box 2309, Maiduguri, Borno State, Nigeria.</span>
                            </li>
                            <li class="flex items-center gap-2">
                                ...
                                <span>+234 708 711 1000 | +234 803 203 1611</span>
                            </li>
                            <li class="flex items-center gap-2">

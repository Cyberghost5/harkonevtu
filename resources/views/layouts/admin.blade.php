...
<head>
    ...
    <title>@yield('title', 'Admin Panel') &ndash; PayPulse</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar"
            ...
            <div class="flex-shrink-0 flex items-center gap-3 px-5 py-4" style="border-bottom:1px solid rgba(255,255,255,0.1)">
                <div class="h-9 w-9 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0" style="background:#4CAF50">
                ...
                <span class="text-lg font-bold font-outfit text-white tracking-tight">PayPulse</span>
                <span class="ml-auto text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-widest" style="background:rgba(76,175,80,0.25);color:#4CAF50">Admin</span>
            </div>

            <!-- Admin user -->
            <div class="flex-shrink-0 px-4 py-3" style="border-bottom:1px solid rgba(255,255,255,0.1)">
                <div class="flex items-center gap-2.5">
                    <div class="h-8 w-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0" style="background:#4CAF50">
                        {{ auth()->user()->initials() }}
                    </div>
                    <div class="min-w-0">
                        <p class="text-xs font-semibold text-white truncate">{{ auth()->user()->displayName() }}</p>
                        <p class="text-[10px]" style="color:#4CAF50">Administrator</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar px-3 py-3 space-y-0.5">
                ...
                <a href="{{ route('admin.dashboard') }}"
                   ...
                   style="{{ $a ? 'background:#4CAF50;color:#fff' : 'color:rgba(255,255,255,0.7)' }}"
                ...
                <div id="settings-menu" class="{{ $settingsOpen ? '' : 'hidden' }} ml-6 mt-0.5 space-y-0.5">
                    ...
                    <a href="{{ route($sub['route']) }}"
                       ...
                       style="{{ $si ? 'background:#4CAF50;color:#fff' : 'color:rgba(255,255,255,0.6)' }}"
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            <header class="flex-shrink-0 flex items-center gap-4 h-14 px-4 sm:px-6 bg-white z-10" style="border-bottom:1px solid #e5e7eb">
                ...
                <div class="flex items-center gap-3 ml-auto">
                    ...
                    <div class="h-8 w-8 rounded-full flex items-center justify-center text-white text-xs font-bold" style="background:#4CAF50">
                        {{ auth()->user()->initials() }}
                    </div>
                </div>
            </header>

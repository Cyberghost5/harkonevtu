        ...
        try {
            if (Schema::hasTable('app_settings')) {
                ...
                config([
                    ...
                    'services.vtpass.base_url' => !empty($s['vtpass_base_url']) ? $s['vtpass_base_url'] : config('services.vtpass.base_url'),
                    ...
                    'services.globacom.email' => !empty($s['globacom_email']) ? $s['globacom_email'] : config('services.globacom.email'),
                    'services.globacom.mode' => !empty($s['globacom_api_mode']) ? $s['globacom_api_mode'] : config('services.globacom.mode'),
